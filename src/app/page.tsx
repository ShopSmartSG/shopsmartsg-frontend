    ...
    return (
        <footer className="p-p-4 p-mt-4 p-2" style={{ backgroundColor: "#f5f5f5", color: "#333" }}>
          <div className="grid justify-between">
            ...
            <div className="col-12 md:col-3 p-md-3">
        ...
        <div className="border-1 surface-border border-round m-2 text-center py-5 px-3">
          <div className="mb-3">
            <img
                ...
                alt={product.name}
                className="w-full h-auto shadow-2"
            />
          </div>
          <div>
        ...
        <Card>
          <div>
            <div className="grid text-center">
              {/* Groceries */}
              <div
                  className="col-12 md:col-3 cursor-pointer"
                  onClick={() =>
                      router.push(
              ...
              >
                <Card footer={footer("Groceries")} className={"h-auto"}>
                  <Image
              ...
              >
                <Card footer={footer("Electronics")} className={"h-auto"}>
                  <Image
              ...
              >
                <Card footer={footer("Clothing")} className={"h-auto"}>
                  <Image
              ...
              >
                <Card footer={footer("Books")} className={"h-auto"}>
                  <Image
